...
<div id="page-wrapper">		
	<div class="container-fluid" style="margin-top: 30px">
        ...
        <form action="<?php echo site_url('admin/edit_tk_ok');?>" method="post">
            ...
            <div class="" style="margin:20px;">
              <p><b>Điểm tích lũy</b></p>
              <input type="text" class="form-control inputlogin1" value="<?php echo $tttk['tichluy']?>" name="tichluy" required>
            </div>
            <div class="" style="margin:20px;">
