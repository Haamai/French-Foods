...
<div>
 <div class="container" style="margin-bottom: 20px;margin-top: 20px;"> 
    ...
    <div class="kmtd" style="margin: 0px;float: right;">
      <div class="km" >
        <div><a href="<?php echo site_url('sukien/khuyenmai') ?>" class="txt1 col-md-4" style="color: #f1d101;font-size: 20px;float: left"><b>Khuyến mãi</b></a></div>
      ...
      <div class="">
        <?php foreach ($khuyenmai as $km){ ?>
          <div class="chitietmon" style="margin-top:20px;">
              <img src="<?php echo public_url()?>/site/image/khuyenmai/<?php echo $km["hinhanh"] ?>" class="imgsmall" style="margin-right: 10px">
              <div class="">
                <span class="chucttd" style="font-size: 18px"><b><?php echo $km["tieude"] ?></b></span><br>
                <span><?php echo $km["noidung"] ?></span><br>
  ...
  <div class="row" style="margin-top:20px;height: 600px;background-image: url('<?php echo public_url()?>/site/image/nenlogin.png')" >
